...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/billowing-breeze-dd71)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-breeze-dd71
```

A live public deployment of this template is available at [https://billowing-breeze-dd71.templates.workers.dev](https://billowing-breeze-dd71.templates.workers.dev)
